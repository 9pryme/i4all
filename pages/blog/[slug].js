    ...
    <>
      ...
      <main className="min-h-screen overflow-x-hidden">
        ...
        <section className="bg-gray-50 py-6 sm:py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              ...
              {/* Title */}
              <h1 
                className="text-2xl sm:text-3xl lg:text-4xl font-cormorant font-bold text-gray-900 mb-6"
              ...
              {post._embedded?.author && (
                <div className="flex items-center mb-6">
                  <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full overflow-hidden bg-gray-300 mr-3">
                    <img 
                  ...
                  <div>
                    <p className="font-medium text-gray-900 text-sm sm:text-base">{post._embedded.author[0].name}</p>
                    <p className="text-xs sm:text-sm text-gray-600">{post._embedded.author[0].description?.slice(0, 50) || 'Author'}</p>
                  </div>
                </div>
              )}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-4 mb-8">
          <div className="relative aspect-[16/9] sm:aspect-[21/9] rounded-xl overflow-hidden shadow-md">
            <Image 
              src={imageUrl} 
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
            <div className="bg-gray-50 rounded-xl p-4 sm:p-6 shadow">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900">Listen to this Episode</h3>
        ...
        <section className="py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              <article className="prose prose-sm sm:prose lg:prose-lg max-w-none [&_img]:rounded-xl [&_video]:rounded-xl [&_iframe]:rounded-xl [&_video]:my-8 [&_iframe]:my-8 [&_video]:w-full [&_iframe]:w-full [&_video]:aspect-video [&_iframe]:aspect-video [&_video]:p-0 [&_iframe]:p-0">
        ...
        <section className="bg-gray-50 py-8 sm:py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl sm:text-3xl font-cormorant font-bold text-gray-900 mb-6 sm:mb-8">Read Next</h2>
            ...
            {relatedPosts.length > 0 ? (
              ...
              <div className="text-center py-6 text-gray-500 text-sm sm:text-base">No related posts found</div>
            )}
          </div>
        </section>
